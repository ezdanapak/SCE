L.controlCredits = function(t) { return new L.CreditsControl(t) }, L.CreditsControl = L.Control.extend({
    ...
    onAdd: function(t) {
        ...
        i.style.backgroundImage = "url(" + this.options.image + ")", this.options.width && (i.style.paddingleft = this.options.width + "px"), this.options.height && (i.style.height = this.options.height + "px");
    ...
    setText: function(t) { this._link.innerHTML = t }
});